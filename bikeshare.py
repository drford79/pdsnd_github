...
def get_filters():
    ...
    """
    print('Hello! Let\'s explore some US bikeshare data and display several descriptive statistics!')
    print('Would you like to see data for Chicago, New York, Washington or for all three cities?')
